...
import {
  ...
  mini_exports,
  parse
} from "./chunk-MIU5FEWQ.js";
import {
  mainnet
} from "./chunk-KOZDNPPH.js";
import {
  Log_exports,
  TransactionReceipt_exports,
  bls12_381,
  ens_normalize
} from "./chunk-H3DBZLRX.js";
import {
  AbiError_exports,
  Base64_exports,
  HDKey,
...
function encode4(ver, ecc, data, type6) {
  let encoded = "";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-MQIF4IZJ.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-5SJKVNSK.js");
...
var init_base = __esm(() => {
  ...
  BaseError2 = class BaseError3 extends Error {
...
`), { name: "InvalidDefinitionTypeError" });
  ...
  UnsupportedPackedAbiType = class UnsupportedPackedAbiType extends BaseError2 {
    constructor(type6) {
...
var init_cursor = __esm(() => {
  ...
  PositionOutOfBoundsError2 = class PositionOutOfBoundsError extends BaseError2 {
...
var init_transaction = __esm(() => {
  ...
  InvalidStorageKeySizeError2 = class InvalidStorageKeySizeError extends BaseError2 {
    constructor({ storageKey: storageKey6 }) {
...
var init_node = __esm(() => {
  ...
  FeeCapTooHighError2 = class FeeCapTooHighError extends BaseError2 {
...
`), {
  ...
  TipAboveFeeCapError2 = class TipAboveFeeCapError extends BaseError2 {
...
function defineFormatter(type6, format4) {
  return ({ exclude, format: overrides }) => {
    return {
      exclude,
      format: (args) => {
        const formatted = format4(args);
        if (exclude) {
...
var init_chain = __esm(() => {
  init_base();
  InvalidChainIdError2 = class InvalidChainIdError extends BaseError2 {
    constructor({ chainId }) {
...
function serializeTransactionDeposit(transaction) {
  ...
  const { sourceHash, data, from: from17, gas, isSystemTx, mint, to: to2, value } = transaction;
  const serializedTransaction = [
    sourceHash,
    from17,
    to2 ?? "0x",
...
function assertTransactionDeposit(transaction) {
  const { from: from17, to: to2 } = transaction;
  if (from17 && !isAddress2(from17))
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-L4P4RFXK.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-JODSCROC.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-CL45EBGX.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    ...
    case "en":
    case "en-US":
      return (await import("./en_US-RFN65H63-L6GR6PS6.js")).default;
    case "es":
    case "es-419":
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    shortName: "Coinbase",
    rdns: "com.coinbase.wallet",
    iconUrl: async () => (await import("./coinbaseWallet-OKXU3TRC-FX7G3Z5P.js")).default,
    iconAccent: "#2c5ff6",
